...
HTTP_ADDR=127.0.0.1:18084 bin/read-api &
READ_PID=$!
...
echo "- read-api  : http://127.0.0.1:18084"
echo ""
echo "Tip: run milestone-1 stack too (gateway/sidecar/realtime/agent) to generate events"
echo ""
